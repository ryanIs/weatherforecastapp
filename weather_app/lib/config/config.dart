 ...
 * config.dart
 * 
 * Stores configuration data to be used throughout the entire application.
 * 
 * @objective Pull from a .yaml or base64 encoded file for better 
 ...
 * ConfigData
 * 
 * Class which stores primary configuration data.
 */
class ConfigData {

  // ---------------------------------------------------------------
  // Your tomorrow.io API KEY. Please use caution with this variable.
  //   https://app.tomorrow.io
  static final String API_KEY = '{INSERT_TOMORROW_IO_API_KEY}';
  // ---------------------------------------------------------------

  // DATA_FETCH_METHOD determines how the fetch component grabs the data.
  // Available options:
  //   > 'state' (default) - Fetches based on the MAIN_STATE (lowercase string, oneword)
  //   > 'latlon' - Fetches based on MAIN_LAT & MAIN_LON.
  //   > 'local' - Fetches to the (already) locally running jsonserver
  ...
  // static final double MAIN_STATE = 'california';
  // static final double MAIN_STATE = 'washington';
  // static final double MAIN_STATE = 'flordia';

  static final String API_VERSION = 'v4';
  static late String API_BASE_URL;
  // static final String API_FORECAST_URL = 'weather/forecast';

  /**
   * ConfigData
   * 
   * This is the main constructor.
   * Sets the API version in the API base URL.
   */
  ConfigData() {
    API_BASE_URL = 'https://api.tomorrow.io/$API_VERSION';
  }
}
 ...
 * AllStateLatLons
 * 
 * Contains static data for each state and their respective latitude and 
 * longitude values.
 * 
 * @deprecated
 */
class AllStateLatLons {

  // StaticStateData contains lat/lon data for each state.
  // Nice - the tomorrow.io API just allows the state name like this: 
  // 'locaiton=minnesota'
  static const Map<String, dynamic> StaticStateData = {
    'washington': {
      'lat': 47.7510,
      'lon': -120.7401,
    },
...
// TomorrowAPIInfo contains helpful data/information related to the tomorrow.io
// API.
class TomorrowAPIInfo {

  // Weather messages based on the provided weather code.
  static Map<String, String> WEATHER_FULL_DAY_MESSAGE = {
      '0': 'Unknown',
      '1000': 'Clear, Sunny',
      '1100': 'Mostly Clear',
      '1101': 'Partly Cloudy',
  ...
  static List<String> ALL_STATES_LIST = [
    'alabama',
    'alaska',
    // 'americansamoa',
    'arizona',
